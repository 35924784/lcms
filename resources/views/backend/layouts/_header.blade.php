                    ...
                    @else
                        <li class="dropdown">
                            <a href="javascript:;" data-toggle="dropdown">
                                <img src="{{ Auth::user()->getAvatar() }}" width="32px" height="32px" class="img-circle"
                                     alt="{{ Auth::user()->name }}"/>&nbsp;&nbsp;
                                {{ Auth::user()->name }}
                                <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="/" target="_blank"><i class="icon icon-home"></i> 首页</a></li>
                                <li><a href="{{ route('user.edit', Auth::user()->id)  }}"><i class="icon icon-edit"></i>
                                        基本资料</a></li>
                                <li><a href="{{ route('administrator.password.edit', Auth::user()->id )  }}"><i
                                ...
                                <li>
                                    ...
                                    <form id="logout-form" action="{{ route('administrator.logout') }}" method="GET"
                                          style="display: none;">
                                        {{ csrf_field() }}
                                    </form>
                                </li>
