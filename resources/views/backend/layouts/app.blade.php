...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="{{ route_class() }}-body">
        ...
        <script src="{{asset('plugins/aliyun/es6-promise.min.js')}}"></script>
        <script src="{{asset('plugins/aliyun/aliyun-oss-sdk-5.2.0.min.js')}}"></script>
        <script src="{{asset('plugins/aliyun/aliyun-upload-sdk-1.4.0.min.js')}}"></script>
