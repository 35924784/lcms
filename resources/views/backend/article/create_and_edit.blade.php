        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <form id="form-validator" class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ $article->id ? route('articles.update', $article->id) : route('articles.store') }}?redirect={{ previous_url() }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group has-feedback  has-icon-right">
                                ...
                                <div class="panel">
                                    <div class="panel-body">
                                        ...
                                        <div id="upload_thumb" type="button" class="btn btn-info uploader-btn-browse"><i class="icon icon-upload"></i> 上传</div>
                                        <div id="select_thumb" type="button" class="btn btn-primary"><i class="icon icon-file-image"></i> 选择</div>
                                        <div id="delete_thumb" type="button" class="btn btn-danger"><i class="icon icon-remove-sign"></i> 删除</div>
                                    </div>
                                </div>
                            </div>
                        </div>
