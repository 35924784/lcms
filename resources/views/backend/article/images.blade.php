    ...
    <div id='myUploader' class="uploader">
        <div>
            {{--<div class="btn-group">--}}
                ...
                <div id="selected-btn-browse" type="button" class="btn btn-primary"><i class="icon icon-file-image"></i> 选择</div>
        ...
        <div class="uploader-files file-list file-list-grid" data-drag-placeholder="">
            ...
            <div class="file file-static" data-id="{{$image['id']}}">
                <div class="file-wrapper">
                    ...
                    <div class="actions">
                        <div type="button" data-toggle="tooltip" title="" class="btn btn-link btn-delete-file" style="display:inline-block;" data-original-title="移除"><i class="icon icon-trash text-danger"></i></div>
                        <div type="button" data-toggle="tooltip" title="" class="btn btn-link btn-sort-file" style="display:inline-block;"><i class="icon icon-move"></i></div>
                    </div>
                </div>
            </div>
            @endforeach
